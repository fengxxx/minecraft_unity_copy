...
{
    public void GenerateChunk(CubicTerrainData terrainDataObject, Vector3 worldspace,ListIndex<int> key)
	{
		/*System.Diagnostics.Stopwatch stopWatch = new System.Diagnostics.Stopwatch ();
		stopWatch.Start ();*/
        this.GenerateTerrainData (terrainDataObject, worldspace,key);
		/*stopWatch.Stop ();
	...
	protected abstract void GenerateTerrainData(CubicTerrainData terrainDataObject, Vector3 worldspace,ListIndex<int>  key);
}
