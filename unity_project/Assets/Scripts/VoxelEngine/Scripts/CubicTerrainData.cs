...
public class CubicTerrainData
{
    ...
    public void setVoxelData(CubicTerrainData ctd)
	{

		_voxelData = ctd.voxelData;
	}
	...
	/// <summary>
	/// Gets the chunk owner terrain.
	/// </summary>
	/// <value>The owner.</value>
	public CubicTerrain owner
	{
		get;
		private set;
	}
	...
	{
		if (y >= this.height || x < 0 || x >= this.width || z < 0 || z >= this.depth || y < 0 || y >= this.height)
			return false;
